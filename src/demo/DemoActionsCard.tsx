...
function DemoActionsCard() {
    ...
    return (
        <AdaptiveCard
            ...
            onActionShowCard={(...args: any[]) => {
                console.log('action show cards  args = ', args)
            }}
            onActionSubmit={(...args: any[]) => {
                console.log('action submit args = ', args)
            }}
            onExecuteAction={(...args: any[]) => {
                console.log('action execute args = ', args)
            }}
